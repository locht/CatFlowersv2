...
class LoginForm(forms.Form):
    ...
    password = PasswordField(label=_("Mật khẩu"))  # Password
    remember = forms.BooleanField(label=_("Ghi nhớ tài khoản"),  # Remember Me
                                  required=False)
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ...
            login_field = forms.CharField(
                label=_("Tên đăng nhập"),  # Username
                widget=login_widget,
...
class BaseSignupForm(_base_signup_form_class()):
    username = forms.CharField(label=_("Tên đăng nhập"),  # Username
                               min_length=app_settings.USERNAME_MIN_LENGTH,
                               widget=forms.TextInput(
                                   attrs={'placeholder':
                                          _('Tên đăng nhập'),  # Username
                                          'autofocus': 'autofocus'}))
    email = forms.EmailField(widget=forms.TextInput(
        attrs={'type': 'email',
               'placeholder': _('Nhập địa chỉ E-mail')}))  # E-mail address
    ...
    def __init__(self, *args, **kwargs):
        ...
        if email_required:
            ...
            self.fields['email'].label = gettext(
                "E-mail (không bắt buộc)")  # E-mail (optional)
...
class SignupForm(BaseSignupForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'] = PasswordField(
            label=_("Mật Khẩu"))  # Password
        if app_settings.SIGNUP_PASSWORD_ENTER_TWICE:
            self.fields['password2'] = PasswordField(
                label=_("Nhập lại mật khẩu"))  # Password (again)
